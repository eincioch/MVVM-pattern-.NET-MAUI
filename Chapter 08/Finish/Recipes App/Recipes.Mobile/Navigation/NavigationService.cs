...
public class NavigationService : INavigationService, INavigationInterceptor
{
    ...
    //public async Task OnNavigatingFrom(object bindingContext, NavigationType navigationType)
    //{
        
    //    //if (bindingContext
    //    //    is INavigatingFrom receiver)
    //    //{
    //    //    await receiver.OnNavigatingFrom(navigationType);
    //    //}
    //}
...
internal static class NavigationRoutes
{
    ...
    public const string RecipeRating = "reciperating";
}
